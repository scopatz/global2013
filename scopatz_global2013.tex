...
While such a tool has many potential use cases, the primary purposes it serves is 
to easily perform code-to-code comparisons for verification and validation of user
input.
